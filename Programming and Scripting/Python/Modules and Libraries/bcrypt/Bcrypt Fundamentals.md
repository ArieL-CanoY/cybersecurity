...
# or you can use the built-in bytes() function
userPass = bytes('password123', 'utf-8')
...
pros: strong hashed and slow to crack the hashed
cons: requires more processing power to generate hashed
