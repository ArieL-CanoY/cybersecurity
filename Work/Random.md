...
transactions:
	...
	CM (Credit Memo) with dynamic credit entry: CM issued by a seller to a buyer used to correct errors in invoices or to provide refund for returned or damaged goods.
		CM batch request
		CM batch approval
